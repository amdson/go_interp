...
checkpoint_callback = ModelCheckpoint(filename="/home/andrew/GO_interp/checkpoints/func_cond_finetune_esmc", 
                                        verbose=True, monitor='loss/val', mode='min')
from pytorch_lightning.loggers import TensorBoardLogger
logger = TensorBoardLogger("cond_logs", name="func_cond_finetune_esmc", default_hp_metric=False)

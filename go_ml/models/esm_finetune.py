...
class ESMFinetune(pl.LightningModule):
    ...
    def training_step(self, batch: tuple, batch_nb: int, *args, **kwargs) -> dict:
        ...
        encoder_lr, cls_lr = tuple(self.scheduler.get_last_lr())
        self.log("encoder_lr", encoder_lr, prog_bar=True, on_step=True)
        self.log("cls_lr", cls_lr, prog_bar=True, on_step=True)

        tqdm_dict = {"train_loss": loss_val, "encoder_lr": encoder_lr}
        output = OrderedDict(

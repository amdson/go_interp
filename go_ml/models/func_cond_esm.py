...
class FuncCondESMFinetune(pl.LightningModule):
    def __init__(self, model_args) -> None:
        ...
        self.model = FuncCondESM(self.base_model.esm.embeddings, self.base_model.esm.encoder, self.base_model.lm_head, 
